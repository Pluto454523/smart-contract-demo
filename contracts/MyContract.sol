...
contract MyContract { // ประกาศ Class MyContract โดยใช้ syntax contract
    string _name;
    uint _balance;
    ...
    // การเรียกใช้ deposite จะมีการเก็บค่า Gas เพราะมีการทำ transaction ในระบบ smart contract
